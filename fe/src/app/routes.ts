...
export const router = createBrowserRouter([
  ...
  },
  {
    ...
    children: [
      ...
      { path: routePaths.adminBuildingRequestNew, Component: RegisterBuildingRequest },
      { path: routePaths.adminBuildingRequests, Component: BuildingRegistrationRequestsList },
      { path: routePaths.adminBuildingRequest, Component: BuildingRegistrationRequestDetail },

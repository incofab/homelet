...
export const env = {
  apiBaseUrl: getEnvValue(import.meta.env.VITE_API_BASE_URL, "http://localhost"),
  apiPrefix: getEnvValue(import.meta.env.VITE_API_PREFIX, "/api"),
  appName: getEnvValue(import.meta.env.VITE_APP_NAME, "Tenanta"),
  appTagline: getEnvValue(import.meta.env.VITE_APP_TAGLINE, "Find your perfect home"),
  ...
  defaultCountry: getEnvValue(import.meta.env.VITE_DEFAULT_COUNTRY, "NG"),
  moneyInKobo: getEnvValue(import.meta.env.VITE_MONEY_IN_KOBO, "true") === "true",
  ...
  authTokenKey: getEnvValue(import.meta.env.VITE_AUTH_TOKEN_KEY, "tenanta_token"),
};

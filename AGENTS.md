...
- After every feature implementation, write a prompt for the frontend AI, letting it know what changes you made and what it needs to do to update the frontend accordingly. The prompt should be appended to the tasks.md file in `fe/docs` folder. If the file doesn't exist, create it.
